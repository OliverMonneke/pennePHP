 ...
 * Calculation
 */
namespace Codersquad\Pennephp\Mathematic;

use Codersquad\Pennephp\Datatype\Number;
use Codersquad\Pennephp\Exception\DivisionByZeroException;

/**
 * Class Calculate
 *
 * @package Codersquad\Pennephp\Mathematic
...
class Calculate
{
     ...
     *
     * @return \Codersquad\Pennephp\Mathematic\Calculate
     */
