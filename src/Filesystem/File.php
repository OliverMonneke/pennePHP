 ...
 * File handling
 */
namespace Codersquad\Pennephp\Filesystem;

use Codersquad\Pennephp\Datatype\Collection;
use Codersquad\Pennephp\Datatype\Number;
use Codersquad\Pennephp\Datatype\Resource;

/**
 * Class File
 *
 * @package Codersquad\Pennephp\Filesystem
...
class File
{
     ...
     *
     * @return \Codersquad\Pennephp\Filesystem\File
     */
